...
function scene:create(e)
	...
	img = display.newImageRect(cookie.image,320,180)
	img.anchorX = 0
	img.anchorY = 0
	img.y = navHeight
	...
	titleText = display.newText(cookie.name, 0, 0, font, size)
	titleText.anchorX = 0
	titleText.anchorY = 1
	titleText.x = Prefs.margin
	titleText.y = img.y + img.height - 12

	shadowText = display.newText(cookie.name, 0, 0, font, size)
